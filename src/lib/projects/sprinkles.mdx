...
export const description = 'A Rust based abstraction layer for Scoop.';
export const pubDate = 'May 20 2024';
export const repo = 'winpax/sprinkles';
export const heroImage =
	'https://cordor.dev/api/og?title=Sprinkles&image=https%3A%2F%2Fcordor.dev%2Femojis%2Fsparkles.svg&backgroundColor=rgba(0%2C0%2C0%2C0)';
export const profileImage = 'https://cordor.dev/emojis/sparkles.svg';
